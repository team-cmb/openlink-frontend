				...
				<ul className='flex items-center flex-shrink-0 space-x-6'>
					...
					<li className='relative'>
						<button
							...
							aria-haspopup='true'
						>
							<BiBell className='w-5 h-5' aria-hidden='true' />
							{/* <!-- Notification badge --> */}
							<span
								aria-hidden='true'
					...
					<li className='relative'>
						...
						>
							<Avatar
								...
								src='https://lh3.googleusercontent.com/ogw/AOLn63F0vjg1zzpSk_VIEs9wtwdX5JtSiMmTY_H8jwIXPw=s32-c-mo'
								alt=''
								aria-hidden='true'
							/>
						</button>
						...
						>
							<DropdownItem tag='a' href='#'>
								<BiUser className='w-4 h-4 mr-3' aria-hidden='true' />
								<span>Profile</span>
							</DropdownItem>
							<DropdownItem tag='a' href='#'>
